  ...
  return project ? (
    <div className="px-6 py-4 w-full rounded-[var(--radius)] lg:w-[650px] shadow-2xl shadow-gray-100">
      ...
      <img
        draggable={false}
        src={project.image}
        className="sm:w-full sm:h-[250px] w-full h-auto aspect-video object-cover rounded-2xl"
        alt={project.title}
      ></img>
      <h1 className="text-2xl font-semibold inline-flex flex-row items-center gap-1 line-clamp-1 pt-8">
        {project.title}
      </h1>
