      ...
      {supabase ? (
        <div className=" relative flex justify-center items-center flex-col gap-0">
          <div className="flex w-full items-center">
            <Input
              type="text"
              className="rounded-r-[0px] focus-visible:ring-0 "
          ...
          {searchResults.length !== 0 && (
            <div
              className={cn(
                'group-["search"] absolute w-full shadow-lg shadow-foreground/5 top-[100%] z-auto',
        ...
        <div className="flex w-full items-center">
          <Input
            type="text"
            className="rounded-r-[0px] focus:ring-0"
            placeholder="Search for subjects..."
          />
          <Button type="submit" variant={'default'} className="rounded-l-[0px]">
            Search
          </Button>
        </div>
      )}
