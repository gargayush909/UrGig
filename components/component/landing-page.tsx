          ...
          <div className="">
            <div className="flex flex-col items-center gap-2 text-center">
              ...
              <div className="flex justify-center items-center gap-4 pt-6">
                <Link href="/projects"><Button variant={"secondary"} className="lg:text-base text-xs">
                  Browse Projects<ArrowRightIcon className="ml-2"/></Button>
                </Link>
                <Link href="/add-project">
                  <Button variant={"outline"} className="lg:text-base text-xs hover:bg-primary">Post Your Project<ArrowRightIcon className="ml-2"/></Button>
                </Link>
              </div>
            </div>
          </div>
